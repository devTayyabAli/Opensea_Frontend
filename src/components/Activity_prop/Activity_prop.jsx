    ...
    return (
        <div>
            <div className="sale_main">
                <div width="90%" className="sc-29427738-0 sc-630fc9ab-0 gOUkGc jSPhMX">
                    <div className="sc-29427738-0 sc-630fc9ab-0 sc-c8cd37b1-0 dVNeWL jSPhMX fwbavo">
                    ...
                    <div data-testid="asset-count" className="sc-29427738-0 sc-bdnxRM kqdVRo fQDfDu">9,998</div>
                </div>
                <Checkbox
                    {...label}
